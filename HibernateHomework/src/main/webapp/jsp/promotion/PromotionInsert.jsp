...
<div class="container">
<h2>活 動 新 增</h2>
<form action="<%= request.getContextPath() %>/PromotionInsert" method="post" enctype="multipart/form-data">

<div class="form-group">
<label>活動名稱</label><input type="text" name="title">
</div>
<div class="form-group">
<label>活動描述</label><input type="text" name="description">
</div>
<div class="form-group">
<label>活動類型</label>
...
<div class="form-group">
<label>使用效期開始</label><input type="date" name="validityFrom">
</div>
<div class="form-group">
<label>使用效期結束</label><input type="date" name="validityTo">
</div>
<div class="form-group">
<label>領取後有效天數</label><input type="text" name="validityDays">
</div>
<div class="form-group">
<label>是否啟用</label>
<select name="active">
